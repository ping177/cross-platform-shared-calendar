...
- Status is `DESIGN FROZEN / IN PROGRESS`: Slice 1 DB foundation is locally verified; Production is not applied and Slices 2–4 are not started. The canonical product and technical contract is [v0.1.15 Shared Lists Specification](./v0.1.15_SHARED_LISTS_SPEC.md). v0.1.14 and v0.1.14.1 remain `CLOSED / PASS`.
