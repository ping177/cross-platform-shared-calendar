...
Review the v0.1.12 Shared Lists scope and design before starting implementation. Keep the separately recorded future navigation direction out of v0.1.12 unless its scope review explicitly adopts it.
