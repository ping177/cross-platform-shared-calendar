...
- v0.1.14.1 Navigation Persistence 已在 Production 完成用户真实账号刷新验收并 `CLOSED / PASS`。v0.1.15 Shared Lists 已完成 Design Freeze，尚未开始实现；当前下一步是 Slice 1 implementation planning / preflight。详见 [v0.1.15 Shared Lists Specification](./docs/v0.1.15_SHARED_LISTS_SPEC.md)。
...
- Shared Lists 当前尚未实现；其 v0.1.15 产品与技术边界已冻结，详见 [canonical specification](./docs/v0.1.15_SHARED_LISTS_SPEC.md)。Task Reminder、recurring Tasks、纪念日、聊天、相册
