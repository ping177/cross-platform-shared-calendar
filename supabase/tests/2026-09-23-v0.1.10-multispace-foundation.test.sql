...
select throws_ok($$select public.set_space_module_enabled('00000000-0000-4000-8000-000000001a11', 'important_dates', true)$$, 'P0001', 'Only Tasks, Review, and Lists modules may be toggled in this version', 'unimplemented modules cannot be toggled yet');
