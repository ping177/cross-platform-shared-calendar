...
select throws_ok($$select public.set_space_module_enabled('00000000-0000-4000-8000-000000001a11', 'lists', true)$$, 'P0001', 'Only the Tasks module may be toggled in this version', 'future modules cannot be toggled yet');
